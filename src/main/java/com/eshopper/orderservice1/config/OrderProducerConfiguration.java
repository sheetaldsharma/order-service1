...
public class OrderProducerConfiguration {
    ...
    @Bean
    public ProducerFactory<String, ProductIdDTO> producerFactoryListOfInt() {
        Map<String, Object> config = new HashMap<>();
    ...
    @Bean
    public KafkaTemplate<String, ProductIdDTO> kafkaTemplateProduct() {
        return new KafkaTemplate<>(producerFactoryListOfInt());
    }
